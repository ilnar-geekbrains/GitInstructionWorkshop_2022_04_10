...
Удалённые репозитории обеспечивают удобство командной работы над кодом
### Базовая работа с удаленными репозиториями GitHub
#### Копирование информации с удаленного репозитория на компьютер
```sh
git clone https://github.com/<user_name>/<file_name>
```
