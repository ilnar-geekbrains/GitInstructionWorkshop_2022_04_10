...
Удаленный репозиторий - это версии вашего проекта, сохраненные в интернете или еще где-то в сети. Удаленный репозиторий необходим для того, чтобы поделиться вашей работой или доставить код на сервер, где он будет выполняться.
